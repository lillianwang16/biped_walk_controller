...
EditableWalking::EditableWalking(Character *cha) : IKVMCController(cha, "Editable Walking") {	
	...
	addTrajectory(state, "SWING_Shoulder", {0.0,1.5}, true);
	addTrajectory(state, "STANCE_Shoulder", {0.0, -1.0}, true);
	addTrajectory(state, "pelvis_lowerback", {0.0, 0}, true);
	addTrajectory(state, "lowerback_torso", {0.0, }, true);
	addTrajectory(state, "torso_head", {0.0, 0.0}, true);
	addTrajectory(state, "SWING_ToeJoint", {0.0, 0});
	addTrajectory(state, "STANCE_ToeJoint", {0.0, 0});
