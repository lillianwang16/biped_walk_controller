...
void ofApp::initScene() {
	...
	bd5.position = b2Vec2(-4.0, 2.5);
	circle2.m_radius = 0.1;
	fd5.shape = &circle2;
	fd5.density = 1.0;
	fd5.friction = 1.8;
	fd5.restitution = 0.35;
	b2Body *ball2 = world_.CreateBody(&bd5);
	ball2->CreateFixture(&fd5);
	b2MassData md3;
	md3.mass = 5;
	md3.I = 0.2;
	md3.center = b2Vec2(0, 0);
	ball2->SetMassData(&md3);
	ball2->SetLinearVelocity(b2Vec2(1.0, -0.5));
	...
	ball->SetMassData(&md2);
	ball->SetLinearVelocity(b2Vec2(-0.0, -0.0));
